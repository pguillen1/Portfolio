...
import portfolio.shared.generated.resources.reading_tracker_library
import portfolio.shared.generated.resources.reading_tracker_settings
import portfolio.shared.generated.resources.reading_tracker_stats
...
val portfolioProjects = listOf(
	Project(
		...
		policyUrl = "",//"https://pguillen1.github.io/Portfolio/privacy/reading-tracker/",
		featured = true,
		previewImages =  listOf(Res.drawable.reading_tracker_library, Res.drawable.reading_tracker_stats, Res.drawable.reading_tracker_settings)
	),
	Project(
		title = "Habit App",
		subtitle = LocalizedText(
		...
		description = LocalizedText(
			en = "An app to track, and complete daily habits.",
			es = "Una app para llevar un seguimiento y completar hábitos diariamente."
		),
		stack = listOf(
			"Kotlin",
			"Jetpack Compose",
		...
		demoUrl = "https://pguillen1.github.io/HabitAppKmp/",
		githubUrl = "https://github.com/pguillen1/HabitAppKmp",
		policyUrl = "",//"https://pguillen1.github.io/Portfolio/privacy/reading-tracker/",
		featured = false,
//		previewImages = listOf(Res.drawable.re, Res.drawable.stats, Res.drawable.settings)
	)
)